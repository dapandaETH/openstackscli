...
> **Note:** The interactive TUI (`openstacks sessions`) requires Node.js 18–22. Node 23+ has a `react-reconciler` compatibility issue with `ink@5`. The `openstacks run` one-shot command works on all Node.js versions.
